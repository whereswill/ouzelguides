...
?>
			<div class="row">
				...
				<div class="col-sm-10"> <!--start content column-->		
					<div>
						<h3 class="pageTitle">All Trips</h3>
					</div>
					<div>
									  ...
									  foreach ($trips as $row) {
									  	...
									  	echo '<tr>' . "\n";
									   	...
									   	echo '<td width=110>' . "\n";
										   	...
										   	echo '<a class="btn btn-success" href="/scheduleTrips/schedule-trip.php?trip_id='.$row['trip_id'].'"><span class="glyphicon glyphicon-share-alt"></span></a>' . "\n";
												echo '</div>' . "\n";
									   	echo '</td>' . "\n";
									   	echo '</tr>' . "\n";
									 }
