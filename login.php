...
<html lang="en">
    <head>
        ...
        <meta name="description" content="OuzelGuides - Ouzel Outfitter's Guide Portal">
        <meta name="author" content="Will Sharp">
        <title>Login | OuzelGuides</title>
                    ...
                    <fieldset>
                      ...
                      <div class="control-group form-group">
                        ...
                        <div class="controls col-lg-8">
                          <input type="text" id="login-username" name="username" placeholder="" class="input-xlarge form-control" autofocus="autofocus"> <br />
                        </div>
                      </div>
